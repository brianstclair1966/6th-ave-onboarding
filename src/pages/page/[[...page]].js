...
export default function PageComponent({ pageNumber, content, sectionTitle, totalItems }) {
  ...
  // them back to page 1 so their work can actually be logged — and so a first-time
  // visitor can't jump ahead to the end without doing the steps. Returning agents
  // simply re-enter their name + email on page 1 to re-link and then revisit freely
  // (page 1 tells them so).
  useEffect(() => {
